...
var Linkifier = (function (_super) {
    ...
    Linkifier.prototype._doLinkifyRow = function (rowIndex, text, matcher, offset) {
        ...
        var line = this._terminal.buffer.lines.get(this._terminal.buffer.ydisp + rowIndex);
        var char = line.get(index);
        var fg;
        if (char) {
        ...
        if (matcher.validationCallback) {
            matcher.validationCallback(uri, function (isValid) {
                ...
                if (isValid) {
                    _this._addLink(offset + index, rowIndex, uri, matcher, fg);
                }
            });
        }
        else {
...
},{"./Buffer":2,"./common/EventEmitter":17,"./ui/MouseZoneManager":49}],10:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
...
},{"../../shared/atlas/CharAtlasGenerator":44,"../ColorManager":27,"./BaseCharAtlas":34,"./LRUMap":38,"./Types":41}],38:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var LRUMap = (function () {
